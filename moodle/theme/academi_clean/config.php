...
$THEME->csspostprocess = 'theme_academi_clean_process_css';
...
$THEME->scss = function ($theme) {
    return theme_academi_clean_get_main_scss_content($theme);
};
$THEME->prescsscallback = 'theme_academi_clean_get_pre_scss';

$THEME->extrascsscallback = 'theme_academi_clean_get_extra_scss';
