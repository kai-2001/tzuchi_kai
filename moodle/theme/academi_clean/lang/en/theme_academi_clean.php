...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><img class=img-polaroid src="academi_clean/pix/screenshot.jpg" /><br/><p></p><h3>Theme Credits</h3><p><h3>Custom Theme</h3><p>Based on Academi.</p>';
...
$string['footerbtitledesc'] = 'Enter a title for this block as plain text or lang:language_key for multi-lingual support. You can find the theme language keys here: /theme/academi_clean/lang/en/theme_academi_clean.php';
...
$string['pluginname'] = 'Academi Clean';
...
$string['title'] = 'Title';
$string['titledesc'] = 'To set the title for the this block, enter the block title as plain text or use the "lang" prefix followed by the appropriate "language_key" for multi-lingual support. You can find the theme language keys for multi-lingual support in the "/theme/academi_clean/lang/en/theme_academi_clean.php" file.';
