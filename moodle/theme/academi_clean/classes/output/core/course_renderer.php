...
namespace theme_academi_clean\output\core;
...
class course_renderer extends \core_course_renderer {
    ...
    public function include_frontslide_js($blockid) {
        $this->page->requires->js_call_amd('theme_academi_clean/frontpage', $blockid, []);
    }
    ...
    public function frontpage_available_courses() {
        global $CFG;
        $displayoption = theme_academi_clean_get_setting('availablecoursetype');
        if ($displayoption != '1') {
    ...
    public function render_template($template, $data) {
        ...
        return $this->output->render_from_template('theme_academi_clean/course_blocks', $data);
    }
    ...
    public function promoted_courses() {
        ...
        $pcoursestatus = theme_academi_clean_get_setting('pcoursestatus');
        $promotedtitle = theme_academi_clean_get_setting('promotedtitle', 'format_html');
        $promotedtitle = theme_academi_clean_lang($promotedtitle);
        $promotedcoursedesc = theme_academi_clean_lang(theme_academi_clean_get_setting('promotedcoursedesc'));
        $featuredids = theme_academi_clean_get_setting('promotedcourses');
        ...
        if (!empty($featuredids)) {
            ...
            $helperobj = new \theme_academi_clean\helper();
        ...
        return $this->output->render_from_template("theme_academi_clean/course_blocks", $template);
    }
    ...
    public function frontpage() {
        ...
        $output = '';
        $themeblocks = new \theme_academi_clean\academi_blocks();
    ...
    protected function coursecat_category(\coursecat_helper $chelper, $coursecat, $depth) {
        ...
        $combolistboxtype = (theme_academi_clean_get_setting('comboListboxType') == 1) ? true : false;
        if ($combolistboxtype) {
            $classes[] = 'collapsed';
        }
