...
namespace theme_academi_clean\output;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function footer_infolinks() {
        $infolink = theme_academi_clean_get_setting('infolink');
        ...
        foreach ($menu->get_children() as $item) {
            ...
            $content .= $this->render_from_template('theme_academi_clean/custom_menu_item', $context);
        }
        return $content;
    }
}
