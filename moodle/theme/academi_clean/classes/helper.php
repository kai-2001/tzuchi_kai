...
/**
 * Theme helper class for the theme_academi_clean.
 *
...
class helper {
    ...
    public function load_additional_scss_settings() {
        $scss = '';
        $primary = theme_academi_clean_get_setting('primarycolor');
        $secondary = theme_academi_clean_get_setting('secondarycolor');
        $slideoverlayval = theme_academi_clean_get_setting('slideOverlay');
        $slideopacity = (!empty($slideoverlayval)) ? $this->get_hexa('#000000', $slideoverlayval) : 0.4;
        $footerbgoverlayval = theme_academi_clean_get_setting('footerbgOverlay');

        $footerbgopacity = (!empty($footerbgoverlayval)) ? $this->get_hexa($primary, $footerbgoverlayval) : 0.4;
        $pagesizecustomval = theme_academi_clean_get_setting('pagesizecustomval');
        $fontsize = theme_academi_clean_get_setting('fontsize');
    ...
    public function render_slideimg($p, $slidername) {
        ...
        $slideimage = '';
        if (theme_academi_clean_get_setting($slidername)) {
