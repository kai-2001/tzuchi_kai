...
class progress_renderer
{
    ...
    private static function time_progress($userprogress, object $videoprogress): string
    {
        ...
        $badge = $completed
            ? '<span class="badge bg-success text-white">' . get_string('completed', 'videoprogress') . '</span>'
            : '<span class="badge bg-secondary text-white">' . get_string('notcompleted', 'videoprogress') . '</span>';
