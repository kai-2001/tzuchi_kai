...
<div class="custom-modal" id="createCourseModal">
    <div class="custom-modal-content" style="max-width: 800px;">
        <div class="custom-modal-header">
            <h3 id="createCourseModalLabel">新增課程 (已更新)</h3>
        ...
        <div class="custom-modal-body">
            ...
            <div class="wizard-steps mb-4 d-flex gap-2">
                <button type="button" class="btn btn-outline-primary flex-fill tab-btn active" data-tab="1"
                    onclick="showTab(1)">
                    <i class="fas fa-info-circle me-1"></i> 1. 基本資訊
                </button>
                <button type="button" class="btn btn-outline-primary flex-fill tab-btn" data-tab="2"
                    onclick="showTab(2)">
                    <i class="fas fa-layer-group me-1"></i> 2. 報名規則
                </button>
                <button type="button" class="btn btn-outline-primary flex-fill tab-btn" data-tab="3"
                    onclick="showTab(3)">
                    <i class="fas fa-box-open me-1"></i> 3. 課程包
                </button>
            </div>
            ...
            <div class="wizard-pane" id="step2" style="display:none;">
                ...
                <div class="alert alert-info border-0 bg-light-primary mb-4">
                    <i class="fas fa-info-circle me-2"></i> 設定誰可以報名此課程。
                </div>
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="alert alert-warning border-0 py-2 small">
                                    ...
                                    不同群組之間是 <b>AND (且)</b> 的關係；同一群組內的條件是 <b>OR (或)</b> 的關係。
                                </div>

                                <div id="rule-groups-container">
                                    <!-- Dynamic Groups -->
                                    <div id="group_default" class="card mb-3 border border-secondary criteria-group">
                                        <div
                                            class="card-header bg-white d-flex justify-content-between align-items-center py-2">
                                            <span class="fw-bold text-primary"><i class="fas fa-layer-group me-1"></i>
                                                條件群組 #1 (OR)</span>
                                            <!-- Default group cannot be deleted easily, or maybe allow? -->
                                        </div>
                                        <div class="card-body bg-white p-2">
                                            <div class="group-conditions-list mb-2">
                                                <!-- Conditions go here -->
                                            </div>
                                            <button type="button"
                                                class="btn btn-outline-secondary btn-sm w-100 border-dashed"
                                                onclick="addConditionToGroup('group_default')">
                                                <i class="fas fa-plus"></i> 加入條件 (例如：職稱=醫師)
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            <!-- Step 3: Course Package -->
            <div class="wizard-pane" id="step3" style="display:none;">
                <div class="form-group mb-3">
                    <label class="form-label">加入課程包 (學習路徑)</label>
                    <select class="form-select" id="new-course-package">
