...
<div class="upload-form">
    ...
    <form action="edit_video.php?id=<?= $video_id ?>" method="POST" enctype="multipart/form-data">
        <div class="form-grid">
            ...
            <div class="form-group">
                <label>講者姓名</label>
                <input type="text" name="speaker_name" value="<?= htmlspecialchars($video['speaker_name']) ?>" required>
            </div>

            <div class="form-group">
                <label>服務單位</label>
                <input type="text" name="affiliation" value="<?= htmlspecialchars($video['affiliation']) ?>" required>
            </div>
