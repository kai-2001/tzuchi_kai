    ...
    <div class="upload-form" style="max-width: 800px; margin: 0 auto;">
        ...
        <form action="edit_announcement.php?id=<?= $announcement['id'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                <div class="form-group">
                    <label>活動日期</label>
                    <input type="date" name="event_date" value="<?= $announcement['event_date'] ?>">
                </div>
                <div class="form-group">
                    <label>地點</label>
            ...
            <div
                ...
                <div class="form-group" style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px;">
                    <input type="checkbox" name="is_hero" id="is_hero" style="width: 20px; height: 20px;"
                        <?= $announcement['is_hero'] ? 'checked' : '' ?>>
                    <label for="is_hero" style="margin: 0; cursor: pointer; font-weight: 600; color: #0ea5e9;">顯示在首頁橫幅
                        (Hero Carousel)</label>
                </div>

                <div id="hero-fields" style="display: <?= $announcement['is_hero'] ? 'block' : 'none' ?>;">
                    <div class="form-group">
