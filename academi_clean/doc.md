...
1. Download the [**Academi**](https://moodle.org/plugins/theme_academi_clean) plugin from the Moodle plugins repository.
2. Copy folder 'academi_clean' and put into theme folder of your moodle system
