...
// Promoted Courses.
$temp = new admin_settingpage('theme_academi_clean_promotedcourse', get_string('promotedcoursesheading', 'theme_academi_clean'));

// Promoted Courses Heading.
$name = 'theme_academi_clean_promotedcoursesheading';
$heading = get_string('promotedcoursesheading', 'theme_academi_clean');
$information = '';
$setting = new admin_setting_heading($name, $heading, $information);
$temp->add($setting);

// Enable / Disable option for Promoted Courses.
$name = 'theme_academi_clean/pcoursestatus';
...
$name = 'theme_academi_clean/promotedtitle';
$title = get_string('title', 'theme_academi_clean');
$description = get_string('promotedtitledesc', 'theme_academi_clean');
$default = 'lang:promotedtitledefault';
$setting = new admin_setting_configtext($name, $title, $description, $default);
$temp->add($setting);

// Promoted courses block description.
$name = 'theme_academi_clean/promotedcoursedesc';
...
// Promoted courses.
$name = 'theme_academi_clean/promotedcourses';
$title = get_string('pcourses', 'theme_academi_clean');
$description = get_string('pcoursesdesc', 'theme_academi_clean');
$default = [];
$courses[0] = '';
$cnt = 0;
