...
/**
 * 開課教師導覽列元件
 * templates/components/teacher-nav.php
 * 
 * 使用 nav-v2 設計風格，分頁導覽
 * Nav 只有：Dashboard、課程管理
...
<head>
    ...
    <script>
        window.PortalConfig = {
            ...
            user: {
                ...
                coursecreatorCategoryIds: <?php echo json_encode($_SESSION['coursecreator_category_ids'] ?? []); ?>
            },
            api: {
    ...
    <script>
        // === Shared helper functions for teacher pages ===
